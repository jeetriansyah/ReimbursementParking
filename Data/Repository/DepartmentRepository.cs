...
namespace Data.Repository
{
    public class DepartmentRepository : IDepartmentRepository
    {
        ...
        {
            var department = myContext.Departments.Where(r => r.DepartmentName == departmentVM.DepartmentName);
            var result = 0;
            if (department != null)
            {
        ...
        {
            return myContext.Departments.Where(r => r.IsDelete == false).ToList().OrderByDescending(r => r.Id);
        }
